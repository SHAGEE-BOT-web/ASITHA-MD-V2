...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=KV0GUKDZ#8xpxmUj_mY5u2QgCaKHO_HyfjKxbOqtb7VuaW0L0G8s' : process.env.SESSION_ID,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "wishmithadineth@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "20090629" : process.env.SEEDER_PASSWORD,
